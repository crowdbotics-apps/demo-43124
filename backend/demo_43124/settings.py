"""
Django settings for demo_43124 project.
...
WSGI_APPLICATION = 'demo_43124.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_43124 API",
    "DESCRIPTION": "API documentation for demo_43124 App",
    "VERSION": "v1",
}
